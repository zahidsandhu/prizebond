        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title text-white"><?php echo $admin_data['admin_name'];?> : Profile </h3>
            </div>
            <div class="row">
              <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        <div class="border-bottom text-center pb-4">
                          <img src="user_photo/<? echo $admin_data['photo']?>" onerror="this.onerror=null; this.src='../user_photo/default.png'" alt="profile" class="img-lg rounded-circle mb-3">
                          <p><? echo $admin_data['admin_name']?></p>
                        </div>
                      </div>
					...
					<!-- <div class="py-4"> -->
	                  <div class="row pt-4 ">
	                  	 ...
	                  	 <!-- <div class="col-sm-9">
	                  	  ...
	                  	  <div class="col-sm-3  ">
	                  	 	<p class="clearfix ">
	                        	<span class="float-left">Admin Name :</span>
	                         </p>
	                  	 </div>
	                  	 <div class="col-sm-9">
	                  	 	<p class="clearfix">
