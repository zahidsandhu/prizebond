        ...
        <div class="card">
          <div class="card-body">
            ...
            if (isset($_POST["Submit"])){
            	...
            	$query=mysqli_query($con,"SELECT *FROM product WHERE product_rates='sa' ");
            	
            	if($query->num_rows > 0){
            			$mesg="<span class='alert alert-info'>File Already Exists</span>";
            			?>
			              <script> setTimeout(function(){ window.location.href ="sa.php"}, 2000);
			            </script>
			            <?php
            	}else{
          ...
          <!-- table work -->
          <?php 
          $sel_product= $query=mysqli_query($con,"SELECT *FROM product WHERE product_rates='sa' ");
       ...
       <div class="d-sm-flex align-items-center mb-4">
        <h4 class="card-title mb-sm-0">
          <?php if(isset($mesg)){
            ...
            echo "UPLOAD PROFIT RATES ACCOUNTS (SA)";
          } 
          ?>
        </h4>
                      ...
                      <table class="table text-white">
                        ...
                        <?php while($row=mysqli_fetch_array($sel_product)){ ?>
                          <tr>
                            ...
                            <td>
                            	<a class="btn btn-danger btn-sm" href="sa.php?delete=<?=$row['id']?>">
                            		Delete
                            	</a>
                            </td>
                          </tr>
