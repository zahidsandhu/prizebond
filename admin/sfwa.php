        ...
        <div class="card">
          <div class="card-body">
            ...
            if (isset($_POST["Submit"])){
            	...
            	$query=mysqli_query($con,"SELECT *FROM product WHERE product_rates='sfwa' ");
            	
            	if($query->num_rows > 0){
            			$mesg="<span class='alert alert-info'>File Already Exists</span>";
            			?>
			              <script> setTimeout(function(){ window.location.href ="sfwa.php"}, 2000);
			            </script>
			            <?php
            	}else{
          ...
          <!-- table work -->
          <?php 
          $sel_product= $query=mysqli_query($con,"SELECT *FROM product WHERE product_rates='sfwa' ");
       ...
       <div class="d-sm-flex align-items-center mb-4">
        <h4 class="card-title mb-sm-0">
          <?php if(isset($mesg)){
            ...
            echo "UPLOAD PROFIT RATES ACCOUNTS (sfwa)";
          } 
          ?>
        </h4>
                      ...
                      <table class="table text-white">
                        ...
                        <?php while($row=mysqli_fetch_array($sel_product)){ ?>
                          <tr>
                            ...
                            <td>
                            	<a class="btn btn-danger btn-sm" href="sfwa.php?delete=<?=$row['id']?>">
                            		Delete
                            	</a>
                            </td>
                          </tr>
