...
<title>Denominations &amp; Prizes - National Savings</title>
<!-- Stylesheets -->
 ...
 <?php include('header.php'); ?>
    ...
    <section class="page-title" style="background-image:url(images/background/8.jpg)">
    	<div class="auto-container">
			<div class="content">
				<h1>Denominations &amp; Prizes <span>Account</span></h1>
				<ul class="page-breadcrumb">
					<li><a href="index.php">Home</a></li>
					<li>Denominations &amp; Prizes - National Savings</li>
				</ul>
			</div>
        </div>
    </section>
	...
	<section class="about-section-four">
		<div class="auto-container">
			...
			<div class="sec-title centered">
				...
				<h2>Denominations &amp; Prizes - <span>National Savings</span></h2>
			</div>
			...
			<div class="row clearfix">
				...
				<div class="col-sm-12 text-center">
				    <figure>
				        <img src="images/27b75ae7-3556-4a50-a903-c1ae91719e93.jpg" alt="some text" class="d-block mx-auto">
				    </figure>
				    <div class="text">
				        <p>As per Govt.Policy. Rate of Tax for filers is 15% of prize value and for non-filers rate of tax is 30% of prize value.</p>
				    </div>
				</div>
