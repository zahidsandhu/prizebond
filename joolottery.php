...
<body>
	...
	<section class="page-title" style="background-image:url(images/background/8.jpg)">
    	<div class="auto-container">
			<div class="content">
				<h1>Prizebond <span>Joo Lottery</span></h1>
				<ul class="page-breadcrumb">
					<li><a href="index.html">Home</a></li>
					<li>Prizebond Joo Lottery</li>
				</ul>
			</div>
        </div>
    </section>
	...
	<section class="blog-list-section">
		<div class="auto-container">
			...
			while ($row=mysqli_fetch_array($result)){
				...
				$posting=$row["posting"];
				$photo=$user["photo"];
				if ($photo=="" || !file_exists("user_photo/".$photo)){
					...
					<div class=\"inner-box\">
						...
						<div class=\"lower-content\">
							<ul class=\"post-meta\">
								...
								<a href=\"userpanel/message.php?uid=$user[uid]\">
									<li><span class=\"fa fa-envelope\"></span>Send private message</li><br>
								</a>
							</ul>
							<h6><img src='extra/user.png' width=\"65\" title='".$user["username"]."' alt='".$user["username"]." icon'/><b>&nbsp;&nbsp;".$user["username"]."</b></h6>
						</div>
					</div>
				</div>
			"; ?>
