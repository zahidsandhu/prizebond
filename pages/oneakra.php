	  ...
	  if (isset($_POST["Submit"])){
			...
			if (strip_tags($posting)==""){
				...
				if ($_POST["Submit"]=="Submit"){
					mysql_query("insert into posting (uid,posting,level, dat, page) values ('".$_SESSION["uid"]."','$posting','1','$dat','".$_GET["post"]."')");
				}else{
					mysql_query("update posting set posting='$posting', level='0' where dat='".$_GET["edit"]."'");
				}
				header("location:?s=1");
			}
	  }
