...
<title>Regular Income Certificates - National Savings</title>
<!-- Stylesheets -->
        	...
        	<div class="row clearfix">
                	...
                	<aside class="sidebar default-sidebar">
                        ...
                        <div class="sidebar-widget contact-widget">
							...
							<table class="table table-hover table-bordered">
							    ...
							    <tr>
							        <td>Denominations</td>
							        <td>50000/-, 100000/-, 500000/-, 1000000/-, 5000000/-, 10000000/-</td>
							    </tr>
							    <tr>
                        ...
                        <div class="sidebar-widget sidebar-blog-category">
                            <ul class="blog-cat">
                                ...
                                <li class="active"><a href="regular-income-certificates.php">Regular Income Certificates
</a></li>
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                	<div class="services-single">
						<h4>Regular Income Certificates

</h4>
                        <figure><img src="images/Regular-income-1160x485.jpg" class="" alt="some text"></figure>
						<div class="text">
						<p>Keeping in view the monthly requirements of the general public, the Regular Income Certificates (RICs) with a maturity period of five years were launched on February 2, 1993.</p>
<p>RICs are available in the denominations of:</p>
<ul>
<li>50,000/-, Rs. 100,000/-, Rs. 500,000/-, Rs. 1,000,000/-, Rs.5,000,000/-, Rs.10,000,000/-</li>
</ul>
<p>Profit is paid on monthly basis started from the date of issue of certificates.</p>
						</div>
    ...
    <div class="card">
      ...
      <div id="collapseTwo" class="collapse" data-parent="#accordion">
        <div class="card-body">
          <p>RIC can be purchased from any National Savings Centre (NSC), Pakistan Post Office (PPO) or authorized branch of a Scheduled Bank and the State Bank of Pakistan (SBP) by filling in the SC-1 (Application form), available free of cost from all the above issuing offices.</p>
...
<p>To download application form, <a href="documents/SC-1.pdf" target="_blank" rel="noopener noreferrer">please click here.</a></p>
        </div>
      </div>
    </div>
    <div class="card">
      ...
      <div id="collapseThree" class="collapse" data-parent="#accordion">
        <div class="card-body">
          <p>RIC can be purchased by depositing cash at the Issuing Office or by presenting a cheque/ draft/ pay-order. The Certificate shall be issued immediately against the cash payment. However, in case of deposit through cheque/ draft/ pay-order, the Certificate shall be issued with effect from the date of realization of the cheque/ draft/ pay-order after receiving the clearance advice.</p>
        </div>
      </div>
    </div>
    <div class="card">
...
<li>No maximum investment limits</li>
    ...
    <div class="card">
      ...
      <div id="collapsefive" class="collapse" data-parent="#accordion">
        <div class="card-body">
        <p>RIC can be encashed at any time and service charges   shall be deducted on the following rates: RIC can be encashed any time after issuance subject to the deduction of service charges If enchased before completion of 1, 2, 3 and 4 years from the date of issue: then 2 %,1.50%, 1%, and 0.50% service charges of the face value shall be deducted. There will no service charges after the completion of 4 years.</p>
<p>The Certificates issued/ purchased/ reinvested on or after November 15, 2010 shall not be reinvested on maturity.</p>
        </div>
      </div>
    </div>
    <div class="card">
      ...
      <div id="collapsesix" class="collapse" data-parent="#accordion">
        <div class="card-body">
          <p><a href="documents/REGULAR-INCOME-CERTIFICATES-PROFIT-RATE.pdf" target="_blank" rel="noopener noreferrer">For rates click here</a></p>
        </div>
      </div>
    </div>
    <div class="card">
