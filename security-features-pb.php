...
<title>Security Features - National Savings</title>
<!-- Stylesheets -->
 ...
 <?php include('header.php'); ?>
    ...
    <section class="page-title" style="background-image:url(images/background/8.jpg)">
    	<div class="auto-container">
			<div class="content">
				<h1>Security Features -  <span>National Savings</span></h1>
				<ul class="page-breadcrumb">
					<li><a href="index.php">Home</a></li>
					<li>Security Features - National Savings</li>
				</ul>
			</div>
        </div>
    </section>
	...
	<section class="about-section-four">
		<div class="auto-container">
			...
			<div class="sec-title centered">
				...
				<h2>Security Features - <span>National Savings</span></h2>
			</div>
			
			<div class="row clearfix">
				
				<!-- Content Column -->
				<div class="news-block-four col-sm-12 col-md-4 col-lg-3 text-center">
				   <div class="inner-box">
				    <div class="image">
				    <div class="w-100">
							<img src="images/40000.jpg" alt="some text" class="d-block mx-auto">
					</div>
				    <div class="overlay-box">
								<a href="images/40000.jpg" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
					</div>
					</div>
					</div>
				</div>
				<div class="news-block-four col-sm-12 col-md-4 col-lg-3 text-center">
				   <div class="inner-box">
				    <div class="image">
				    <div class="w-100">
							<img src="images/25000.jpg" alt="some text" class="d-block mx-auto">
					</div>
				    <div class="overlay-box">
								<a href="images/25000.jpg" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
					</div>
					</div>
					</div>
				</div>
				<div class="news-block-four col-sm-12 col-md-4 col-lg-3 text-center">
				   <div class="inner-box">
				    <div class="image">
				    <div class="w-100">
							<img src="images/15000.jpg" alt="some text" class="d-block mx-auto">
					</div>
				    <div class="overlay-box">
								<a href="images/15000.jpg" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
					</div>
					</div>
					</div>
				</div>
				...
				<div class="news-block-four col-sm-12 col-md-4 col-lg-3 text-center">
				   <div class="inner-box">
				    <div class="image">
				    <div class="w-100">
							<img src="images/7500.jpg" alt="some text" class="d-block mx-auto">
					</div>
				    <div class="overlay-box">
								<a href="images/7500.jpg" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
					</div>
					</div>
					</div>
				</div>
				...
				<div class="news-block-four col-sm-12 col-md-4 col-lg-3 text-center">
				   <div class="inner-box">
				    <div class="image">
				    <div class="w-100">
							<img src="images/1500.jpg" alt="some text" class="d-block mx-auto">
					</div>
				    <div class="overlay-box">
								<a href="images/1500.jpg" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
					</div>
					</div>
					</div>
				</div>
				...
				<div class="news-block-four col-sm-12 col-md-4 col-lg-3 text-center">
				   <div class="inner-box">
				    <div class="image">
				    <div class="w-100">
							<img src="images/750.jpg" alt="some text" class="d-block mx-auto">
					</div>
				    <div class="overlay-box">
								<a href="images/750.jpg" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
					</div>
					</div>
					</div>
				</div>
				...
				<div class="news-block-four col-sm-12 col-md-4 col-lg-3 text-center">
				   <div class="inner-box">
				    <div class="image">
				    <div class="w-100">
							<img src="images/200.jpg" alt="some text" class="d-block mx-auto">
					</div>
				    <div class="overlay-box">
								<a href="images/200.jpg" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
					</div>
					</div>
					</div>
				</div>
				...
				<div class="news-block-four col-sm-12 col-md-4 col-lg-3 text-center">
				   <div class="inner-box">
				    <div class="image">
				    <div class="w-100">
							<img src="images/100.jpg" alt="some text" class="d-block mx-auto">
					</div>
				    <div class="overlay-box">
								<a href="images/100.jpg" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
					</div>
					</div>
					</div>
				</div>
