	...
	<table width="800px" class="pagewidth-tbl" cellspacing="0" align="center">
		...
		<?php
						...
						while ($row=mysql_fetch_array($result)){
							echo "
							<td>
							<img src='user_upload_paper/".$row["posting"]."' width='500' alt='Thailand Lottery Vip Paper' title='Thailand Lottery Vip Paper'>
							</td>
							";
						}
						echo "</tr></table><br<br>";
			...
			while ($row=mysql_fetch_array($result)){
			 ...
			 <table width="800" class="pagewidth-tbl" align="center">
			 	<tr>
					...
					<div class='morepost'><a href='?user=".$user["username"]."' title='".$user["username"]." More Thailand Papers'>".$user["username"]." More Thailand Papers</a></div>
					<img src='user_upload_paper/$posting' width='600px' height='600px' alt='Thailand paper' title='Thailand p paper'>"; ?>
					<br /><br />
